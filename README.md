...
> **Current Version**：`2.3.x.20241003-SNAPSHOT`<br>
> **JDK Baseline**：`1.8`<br>
...
**redistpl-plus-spring-boot-starter** is a Spring Boot starter that integrates **spring-biz** for applications using spring-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume spring-biz capabilities with minimal setup.
...
| JDK | `1.8` |
| Coordinates | `io.github.easy4j:redistpl-plus-spring-boot-starter:2.3.x.20241003-SNAPSHOT` |
...
<dependency>
    ...
    <version>2.3.x.20241003-SNAPSHOT</version>
</dependency>
```
