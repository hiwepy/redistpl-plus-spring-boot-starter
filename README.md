...
| JDK | `1.8` |
| Coordinates | `io.github.easy4j:redistpl-plus-spring-boot-starter:2.7.x.20260527-SNAPSHOT` |
| Config Prefix | `spring.redis.jackson` |
...
| Property Binding | ✅ Stable | Binds `spring.redis.jackson.*` to `RedisJacksonProperties` |
...
|---|---|---|:---:|---|:---:|
| `spring.redis.jackson.enabled` | boolean | `true` | No | Enable the starter | No |
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `spring.redis.jackson.enabled=true` and classpath |
